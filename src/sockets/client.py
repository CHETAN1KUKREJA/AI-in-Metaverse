...
class SocketClient:
    ...
    def _read_until_json(self):
        ...
        while self.is_running:
            ...
            while not flag_found_end:
                chunk = self.socket.recv(4096).decode('utf-8') # TODO this is tmp solution for laarge data, need to be fixed with a cycle
